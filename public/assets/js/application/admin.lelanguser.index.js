jQuery(document).ready(function(){
    ...
    var albums_table = jQuery('#dyntable').dataTable({
        ...
        "bProcessing": true,
        "sAjaxSource": '/admin/lelangs/api_get_all_lelanguser?id_ruas=' + jQuery('#id_ruas').val(),  
        "dom": 'Bfrtip',
		"buttons": [ 'excel'], 
    });
    ...
    $btn_edit.on('click', function(e) {
        ...
        if (checked_count == 1) {
            ...
            window.location.href = "/admin/lelangs/edit/" + checked_categories[0];
    ...
    $btn_show.on('click', function(e) {
        ...
        if (checked_count == 1) {
            ...
            window.location.href = "/admin/lelangs/show/" + checked_categories[0];
        } else if (checked_count == 0) {
            jAlert('Silakan pilih minimal 1 data terlebih dahulu.');
        } else {
            jAlert('Maksimal memilih 1 data untuk diubah.');
                        ...
                        jQuery.ajax({
                            ...
                            success:function(response) {
                                if (response.status == "success") {
                                    ...
                                    window.location.href = '/auctions_list?id_ruas=' + jQuery('#filter_ruas').val();
                                } else {
    ...
    jQuery('#filter_ruas').on('change', function(){
        window.location.href = '/auctions_list?id_ruas=' + jQuery('#filter_ruas').val();
    });
