...
class Article_Sub_Categories extends CI_Controller {
	public $user_access;
	...
	public function index() {
		...
		$data = array(
			...
			'content' => $this->load->view('admin/article_sub_categories/index', array('flash'=>$this->session->flashdata('article_sub_categories_success')), true),
			'jscripts' => $jscripts,
