...
<style>
	...
	<div id="artikel" class="col-sm-12 col-md-8">
		<h4 class="title"><?php echo lang('rekapitulasi-spm'); ?></h4>
		<hr class="divider">
      <!-- single post -->
      <div class="body">
          ...
          <div class="list-group">
            ...
            <a class="result" href="<?php echo $document->url; ?>" target="_blank"><button type="button" class="list-group-item"><span class="glyphicon glyphicon-save" aria-hidden="true"></span>  <?php echo $document->title; ?></button></a>
