        ...
        <div id="profil-artikel" class="row">
            ...
            <div id="artikel" class="col-sm-12 col-md-8">
				  ...
				  <ul class="breadcrumb" style="padding-left: 0px; background-color:#fff;">
					...
					<li><a href="#"><?php echo ($lang == 'id') ? $parent_menu->name : $parent_menu->name_en; ?></a> <span class="separator"></span></li>
					<li></li>
				</ul>
                ...
                <div class="body">
                    ...
                    <div class="image">
						<?php if (!empty($show_image)) { ?>
							...
							<img src="<?php echo $this->media->get_image_by_style($content->image_name, 'pn640'); ?>" class="img-responsive"  onerror="this.src='/bpjt/assets/images/no-image.jpg'" alt="" /> 
							<?php } ?>
						  <?php } ?>
					</div>
