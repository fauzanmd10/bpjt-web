            ...
            <div id="artikel" class="col-sm-12 col-md-8">
                ...
                <div class="body">
                    ...
                    <div class="galeri-foto col-sm-12">
                        <div class="col-sm-3">
						<a href="<?php echo site_url('galeri-video/album-video/' . $media->album_slug . '/show/' . create_slug($media->title) . '/' . $media->id); ?>">
							<img src="<?php echo get_video_thumbnail($media->url); ?>" alt="<?php echo $media->title; ?>" alt="<?php echo $media->title; ?>" class="img-responsive"  onerror="this.src='/bpjt/assets/images/no-image.jpg'" alt="" /> 
						</a>
						</div>
						<div class="col-sm-9">
                            <p class="galeri-meta"><?php echo print_casual_date($media->created_at); ?>&nbsp;&nbsp;&nbsp;<span class="label label-info"><?php echo $media->album_name; ?></span></p>
                            <h5 class="galeri-heading"><a href="<?php echo site_url('galeri-video/album-video/' . $media->album_slug . '/show/' . create_slug($media->title) . '/' . $media->id); ?>"><?php echo $media->title; ?></a></h5>
