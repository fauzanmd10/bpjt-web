    ...
    <div id="content" class="container-fluid">
        ...
        <div id="profil-artikel" class="row">
					...
					<div class="panel panel-default">
						<div class="panel-heading" role="tab" id="headingBerita">
							<h4 class="panel-title">
								<p>
									<span class="pull-left"><?php echo lang('galeri-video'); ?></span>
								...
								<div class="panel-group subpanel" id="accordionCapaian">
									<div class="panel panel-default">
										<div class="panel-heading" role="tab" id="headingCapaian">
											<h4 class="panel-title">
												<a style="text-transform:capitalize" href="<?php echo site_url('galeri-video/album-video/' . $video_album->slug); ?>" title="<?php echo $video_album->name; ?>">
												<?php echo $video_album->name; ?></a>
											</h4>
										</div>
									</div>
				...
				<div class="panel-group" id="accordionProfil" role="tablist" aria-multiselectable="true">
                    <div class="panel panel-default">
                        <div id="collapseProfil" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="collapseProfil" style="margin-left:20px;">
							<a href="<?php echo site_url('berita'); ?>"><img src="<?php echo base_url(); ?>assets/images/index-berita.png" alt="" title="<?php echo lang('index-berita'); ?>" class="icon-fr"/></a>
							<a href="http://gis.bpjt.pu.go.id/" target="_blank"><img src="<?php echo base_url(); ?>assets/images/map2.png" alt="" title="<?php echo lang('gis-bpjt'); ?>" class="icon-fr"/></a>
							<a href="<?php echo site_url('spm'); ?>"><img src="<?php echo base_url(); ?>assets/images/spm2.png" alt="" title="<?php echo lang('standar-pelayanan-minimal'); ?>" class="icon-fr"/></a>
							<a href="<?php echo site_url('konten/bujt'); ?>"><img src="<?php echo base_url(); ?>assets/images/peluanginvestasi2.png" alt="" title="<?php echo lang('peluang-investasi'); ?>" class="icon-fr"/></a>
							<a href="<?php echo site_url('konten/bujt'); ?>"><img src="<?php echo base_url(); ?>assets/images/bujt2.png" alt="" title="<?php echo lang('bujt-long'); ?>" class="icon-fr"/></a>
							<a href="<?php echo site_url('cek-tarif-tol'); ?>"><img src="<?php echo base_url(); ?>assets/images/tarif.png" alt="" title="<?php echo lang('cek-tarif-tol'); ?>" class="icon-fr"/></a>
							<a href="/bpjt/cek_tarif"><img src="<?php echo base_url(); ?><?php echo lang('gambar-cek-tarifmap'); ?>" alt="" title="<?php echo lang('cek-tarif-tolmap'); ?>" class="icon-fr"/></a>
            ...
            <div id="artikel" class="col-sm-12 col-md-8">
                <h4 class="title"><?php echo lang('galeri-album-video'); ?></h4>
                <hr class="divider"><br/>
				<div id="collapseBerita" role="tabpanel" aria-labelledby="collapseBerita">
					...
					<div class="galeri-foto col-sm-12">
                        <div class="col-sm-3">
						<a href="<?php echo site_url('galeri-video/album-video/' . $media->album_slug . '/show/'. create_slug($media->title) . '/' . $media->id); ?><?php echo (isset($_GET['page'])) ? "?page=" . clean_str($_GET['page']) : ""; ?>"><img src="<?php echo get_video_thumbnail($media->url); ?>" alt="<?php echo $media->title; ?>" width="185" height="137" /></a>
						</div>
						<!-- meta -->
						<div class="col-sm-9">
							<h4><a href="<?php echo site_url('galeri-video/album-video/' . $media->album_slug . '/show/'. create_slug($media->title) . '/' . $media->id); ?><?php echo (isset($_GET['page'])) ? "?page=" . clean_str($_GET['page']) : ""; ?>"><?php echo $media->title; ?></a></h4>
							<div class="date">
								<p class="galeri-meta"><?php echo print_normal_date($media->created_at); ?>&nbsp;&nbsp;&nbsp;&nbsp;
								<a href="<?php echo site_url('galeri-video/album-video/' . $media->album_slug); ?>"><span class="label label-info"><?php echo $media->album_name; ?></span></a> </p>
							</div>
							<!-- end date -->
