		...
		<section id="page-title">
			...
			<div class="container clearfix">
				...
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item"><a href="#">Kuesioner Badan Hukum</a></li>
				</ol>
			</div>
			...
			<div class="content-wrap">
				...
				<div class="row gutter-40 col-mb-80">
					<div class="postcontent col-lg-9">
						...
						<iframe src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRJ8sxUYPcO4kJyg4ghGVOpERYyCdHf1YyDRZWHCr_KkN0u_bavbcUdCBJc4WmBR386itGagcXf1OLI/pubhtml?gid=1408057601&amp;single=true&amp;widget=true&amp;headers=false"  width="100%" height="780" frameborder="0" marginheight="0" marginwidth="0" scrolling="no"></iframe>
					</div>
