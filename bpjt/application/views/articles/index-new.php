						...
						<div class="postcontent col-lg-9">
									...
									<div class="grid-inner row g-0 p-4">
										<div class="col-md-5 mb-md-0">
											<a href="#" class="entry-image">
												...
												<img src="<?php echo (isset($article->image_name)) ? $this->media->get_image_by_style($article->image_name, 'pn640') : base_url() . "assets/images/no-image.jpg"; ?>" alt="<?php echo $article->title; ?>" onerror="this.src='/assets/images/no-image.jpg'">
											<?php }else{ ?>
												<img src="<?php echo (isset($article->image_name)) ? $this->media->get_image_by_style($article->image_name, '') : base_url() . "assets/images/no-image.jpg"; ?>" alt="<?php echo $article->title; ?>" onerror="this.src='/assets/images/no-image.jpg'">
											<?php }; ?>
							...
							<?php $dot?>
						        <?php for($i=1; $i<=$total_page; $i++) { ?>
									<?php if ($i <=1 ) { 
										$dot=$i;?>
										<li <?php echo ($i==$page) ? "class='page-item active'" : ""; ?>><a href="?&page=<?php echo $i; ?>" <?php echo ($i==$page) ? "class='page-link'" : ""; ?> class="page-link"><?php echo $i; ?></a></li>
									...
									<?php }else if(($page - 1 ==$i) || ($page - 2 ==$i) || ($page - 3 ==$i)){
										...
										?>
										<li <?php echo ($i==$page) ? "class='page-item active'" : ""; ?>><a href="?&page=<?php echo $i; ?>" <?php echo ($i==$page) ? "class='page-link'" : ""; ?> class="page-link"><?php echo $i; ?></a></li>
									<?php }else if(($page + 2 ==$i) || ($page + 2 ==$i) || ($page + 3 ==$i)){?>
										<li <?php echo ($i==$page) ? "class='page-item active'" : ""; ?>><a href="?&page=<?php echo $i; ?>" <?php echo ($i==$page) ? "class='page-link'" : ""; ?> class="page-link"><?php echo $i; ?></a></li>
												...
												<div class="grid-inner row g-0">
													<div class="col-auto">
														<div class="entry-image">
															<a href="<?php echo site_url('berita/' . $popular_article->slug); ?>"><img src="<?php echo $this->media->get_image_by_style($popular_article->image_name, ''); ?>" alt="<?php echo $popular_article->title; ?>"></a>
														</div>
													</div>
													<div class="col ps-3">
