  ...
  <ul class="nav nav-tabs nav-stacked">
    ...
    <li class="dropdown <?php echo ($route_check || $this->router->fetch_class() == 'menus' || $this->router->fetch_class() == 'articles' || $this->router->fetch_class() == 'announcements' || $this->router->fetch_class() == 'article_categories' || $this->router->fetch_class() == 'article_sub_categories' || $this->router->fetch_class() == 'contents' || $this->router->fetch_class() == 'spm_classifications' || $this->router->fetch_class() == 'spm' || $this->router->fetch_class() == 'spm_reports' || $this->router->fetch_class() == 'spm_scores' || $this->router->fetch_class() == 'spm_score_remarks' || $this->router->fetch_class() == 'toll_roads' || $this->router->fetch_class() == 'toll_gates' || $this->router->fetch_class() == 'toll_tariffs' || $this->router->fetch_class() == 'vehicle_groups' || $this->router->fetch_class() == 'regulations' || $this->router->fetch_class() == 'comments') ? "active" : ''; ?>">
      ...
      <ul <?php echo ($this->router->fetch_class() == 'menus' || $this->router->fetch_class() == 'articles' || $this->router->fetch_class() == 'announcements' || $this->router->fetch_class() == 'article_categories' || $this->router->fetch_class() == 'article_sub_categories' || $this->router->fetch_class() == 'contents' || $this->router->fetch_class() == 'spm_classifications' || $this->router->fetch_class() == 'spm' || $this->router->fetch_class() == 'spm_reports' || $this->router->fetch_class() == 'spm_scores' || $this->router->fetch_class() == 'spm_score_remarks' || $this->router->fetch_class() == 'toll_roads' || $this->router->fetch_class() == 'toll_gates' || $this->router->fetch_class() == 'toll_tariffs' || $this->router->fetch_class() == 'vehicle_groups' || $this->router->fetch_class() == 'regulations' || $this->router->fetch_class() == 'comments') ? "style='display:block;'" : ''; ?>>
        ...
        <?php } ?>
        <li><a href="<?php echo site_url('admin/Register_auction/add_invest2'); ?>">Lelang Toll</a>
        </li>
        <!-- <li class="dropdown">
                <a href="#">BPJT</a>
                <ul <?php //echo ($this->router->fetch_class() == 'contents' && $this->uri->segment(3) == 'bpjt') ? "style='display:block;'" : ""; 
                    ?>>
                  <li><a href="<?php //echo site_url('admin/contents/bpjt/sekilas-bpjt'); 
                                ?>" <?php //echo ($this->router->fetch_class() == 'contents' && $this->uri->segment(3) == 'bpjt' && $this->uri->segment(4) == 'sekilas-bpjt') ? "style='text-decoration:none;background-color:rgb(255, 255, 255);color:rgb(234, 178, 0);'" : ""; 
                                    ?>>Sekilas BPJT</a></li>
                  <li><a href="<?php //echo site_url('admin/contents/bpjt/visi-misi'); 
                                ?>" <?php //echo ($this->router->fetch_class() == 'contents' && $this->uri->segment(3) == 'bpjt' && $this->uri->segment(4) == 'visi-misi') ? "style='text-decoration:none;background-color:rgb(255, 255, 255);color:rgb(234, 178, 0);'" : ""; 
                                    ?>>Visi dan Misi</a></li>
                  <li><a href="<?php //echo site_url('admin/contents/bpjt/struktur-organisasi'); 
                                ?>" <?php //echo ($this->router->fetch_class() == 'contents' && $this->uri->segment(3) == 'bpjt' && $this->uri->segment(4) == 'struktur-organisasi') ? "style='text-decoration:none;background-color:rgb(255, 255, 255);color:rgb(234, 178, 0);'" : ""; 
                                    ?>>Struktur Organisasi</a></li>
                  <li><a href="<?php //echo site_url('admin/contents/bpjt/tugas-bpjt'); 
                                ?>" <?php //echo ($this->router->fetch_class() == 'contents' && $this->uri->segment(3) == 'bpjt' && $this->uri->segment(4) == 'tugas-bpjt') ? "style='text-decoration:none;background-color:rgb(255, 255, 255);color:rgb(234, 178, 0);'" : ""; 
                                    ?>>Tugas BPJT</a></li>
                </ul>
              </li> -->
        <!-- <li class="dropdown">
                ...
                <ul <?php //echo ($this->router->fetch_class() == 'contents' && $this->uri->segment(3) == 'jalan-tol') ? "style='display:block;'" : ""; 
                    ?>>
                  <li><a href="<?php //echo site_url('admin/contents/jalan-tol/sejarah'); 
                                ?>" <?php //echo ($this->router->fetch_class() == 'contents' && $this->uri->segment(3) == 'jalan-tol' && $this->uri->segment(4) == 'sejarah') ? "style='text-decoration:none;background-color:rgb(255, 255, 255);color:rgb(234, 178, 0);'" : ""; 
                                    ?>>Sejarah</a></li>
                  <li><a href="<?php //echo site_url('admin/contents/jalan-tol/tujuan-manfaat'); 
                                ?>" <?php //echo ($this->router->fetch_class() == 'contents' && $this->uri->segment(3) == 'jalan-tol' && $this->uri->segment(4) == 'tujuan-manfaat') ? "style='text-decoration:none;background-color:rgb(255, 255, 255);color:rgb(234, 178, 0);'" : ""; 
                                    ?>>Tujuan dan Manfaat</a></li>
                  <li><a href="<?php //echo site_url('admin/contents/jalan-tol/kebijakan-percepatan-pembangunan'); 
                                ?>" <?php //echo ($this->router->fetch_class() == 'contents' && $this->uri->segment(3) == 'jalan-tol' && $this->uri->segment(4) == 'kebijakan-percepatan-pembangunan') ? "style='text-decoration:none;background-color:rgb(255, 255, 255);color:rgb(234, 178, 0);'" : ""; 
                                    ?>>Kebijakan Percepatan Pembangunan</a></li>
                  <li><a href="<?php //echo site_url('admin/contents/jalan-tol/nama-ruas-tol'); 
                                ?>" <?php //echo ($this->router->fetch_class() == 'contents' && $this->uri->segment(3) == 'jalan-tol' && $this->uri->segment(4) == 'nama-ruas-tol') ? "style='text-decoration:none;background-color:rgb(255, 255, 255);color:rgb(234, 178, 0);'" : ""; 
                                    ?>>Nama Ruas Tol</a></li>
                  <li><a href="<?php //echo site_url('admin/contents/jalan-tol/trafik-pengguna'); 
                                ?>" <?php //echo ($this->router->fetch_class() == 'contents' && $this->uri->segment(3) == 'jalan-tol' && $this->uri->segment(4) == 'trafik-pengguna') ? "style='text-decoration:none;background-color:rgb(255, 255, 255);color:rgb(234, 178, 0);'" : ""; 
                                    ?>>Trafik Pengguna</a></li>
                </ul>
              </li> -->
        <li class="dropdown">
          <a href="#">SPM</a>
        ...
        <!-- <li><a href="<?php //echo site_url('admin/contents/bujt'); 
                          ?>" <?php //echo ($this->router->fetch_class() == 'contents' && $this->uri->segment(3) == 'bujt') ? "style='text-decoration:none;background-color:rgb(255, 255, 255);color:rgb(234, 178, 0);'" : ""; 
                              ?>>BUJT</a></li> -->
        <li class="dropdown">
        ...
        <!-- <li class="dropdown">
                ...
                <ul <?php //echo ($this->router->fetch_class() == 'contents' && $this->uri->segment(3) == 'investasi') ? "style='display:block;'" : ""; 
                    ?>>
                  <li><a href="<?php //echo site_url('admin/contents/investasi/prinsip-penyelenggaraan'); 
                                ?>" <?php //echo ($this->router->fetch_class() == 'contents' && $this->uri->segment(3) == 'investasi' && $this->uri->segment(4) == 'prinsip-penyelenggaraan') ? "style='text-decoration:none;background-color:rgb(255, 255, 255);color:rgb(234, 178, 0);'" : ""; 
                                    ?>>Prinsip Penyelenggaraan</a></li>
                  <li><a href="<?php //echo site_url('admin/contents/investasi/skema-investasi'); 
                                ?>" <?php //echo ($this->router->fetch_class() == 'contents' && $this->uri->segment(3) == 'investasi' && $this->uri->segment(4) == 'skema-investasi') ? "style='text-decoration:none;background-color:rgb(255, 255, 255);color:rgb(234, 178, 0);'" : ""; 
                                    ?>>Skema Investasi</a></li>
                  <li><a href="<?php //echo site_url('admin/contents/investasi/tahapan-makro-pengusahaan-jalan-tol'); 
                                ?>" <?php //echo ($this->router->fetch_class() == 'contents' && $this->uri->segment(3) == 'investasi' && $this->uri->segment(4) == 'tahapan-makro-pengusahaan-jalan-tol') ? "style='text-decoration:none;background-color:rgb(255, 255, 255);color:rgb(234, 178, 0);'" : ""; 
                                    ?>>Tahapan Makro Pengusahaan Jalan Tol</a></li>
                  <li><a href="<?php //echo site_url('admin/contents/investasi/prosedur-investasi'); 
                                ?>" <?php //echo ($this->router->fetch_class() == 'contents' && $this->uri->segment(3) == 'investasi' && $this->uri->segment(4) == 'prosedur-investasi') ? "style='text-decoration:none;background-color:rgb(255, 255, 255);color:rgb(234, 178, 0);'" : ""; 
                                    ?>>Prosedur Investasi</a></li>
                </ul>
              </li> -->
        <!-- <li class="dropdown">
                <a href="#">Progress</a>
                <ul <?php //echo ($this->router->fetch_class() == 'contents' && $this->uri->segment(3) == 'progress-pembangunan') ? "style='display:block;'" : ""; 
                    ?>>
                  <li><a href="<?php //echo site_url('admin/contents/progress-pembangunan/rencana'); 
                                ?>" <?php //echo ($this->router->fetch_class() == 'contents' && $this->uri->segment(3) == 'progress-pembangunan' && $this->uri->segment(4) == 'rencana') ? "style='text-decoration:none;background-color:rgb(255, 255, 255);color:rgb(234, 178, 0);'" : ""; 
                                    ?>>Rencana</a></li>
                  <li><a href="<?php //echo site_url('admin/contents/progress-pembangunan/ruas-tol'); 
                                ?>" <?php //echo ($this->router->fetch_class() == 'contents' && $this->uri->segment(3) == 'progress-pembangunan' && $this->uri->segment(4) == 'ruas-tol') ? "style='text-decoration:none;background-color:rgb(255, 255, 255);color:rgb(234, 178, 0);'" : ""; 
                                    ?>>Ruas Tol</a></li>
                  <li><a href="<?php //echo site_url('admin/contents/progress-pembangunan/progress'); 
                                ?>" <?php //echo ($this->router->fetch_class() == 'contents' && $this->uri->segment(3) == 'progress-pembangunan' && $this->uri->segment(4) == 'progress') ? "style='text-decoration:none;background-color:rgb(255, 255, 255);color:rgb(234, 178, 0);'" : ""; 
                                    ?>>Progress</a></li>
                  <li><a href="<?php //echo site_url('admin/contents/progress-pembangunan/beroperasi'); 
                                ?>" <?php //echo ($this->router->fetch_class() == 'contents' && $this->uri->segment(3) == 'progress-pembangunan' && $this->uri->segment(4) == 'beroperasi') ? "style='text-decoration:none;background-color:rgb(255, 255, 255);color:rgb(234, 178, 0);'" : ""; 
                                    ?>>Beroperasi</a></li>
                  <li><a href="<?php //echo site_url('admin/contents/progress-pembangunan/jalan-tol-ppjt'); 
                                ?>" <?php //echo ($this->router->fetch_class() == 'contents' && $this->uri->segment(3) == 'progress-pembangunan' && $this->uri->segment(4) == 'jalan-tol-ppjt') ? "style='text-decoration:none;background-color:rgb(255, 255, 255);color:rgb(234, 178, 0);'" : ""; 
                                    ?>>Jalan Tol PPJT</a></li>
                  <li><a href="<?php //echo site_url('admin/contents/progress-pembangunan/tender-tender'); 
                                ?>" <?php //echo ($this->router->fetch_class() == 'contents' && $this->uri->segment(3) == 'progress-pembangunan' && $this->uri->segment(4) == 'tender-tender') ? "style='text-decoration:none;background-color:rgb(255, 255, 255);color:rgb(234, 178, 0);'" : ""; 
                                    ?>>Tender-Tender</a></li>
                  <li><a href="<?php //echo site_url('admin/contents/progress-pembangunan/persiapan-tender'); 
                                ?>" <?php //echo ($this->router->fetch_class() == 'contents' && $this->uri->segment(3) == 'progress-pembangunan' && $this->uri->segment(4) == 'persiapan-tender') ? "style='text-decoration:none;background-color:rgb(255, 255, 255);color:rgb(234, 178, 0);'" : ""; 
                                    ?>>Persiapan Tender</a></li>
                </ul>
              </li> -->
        ...
        <!--<li><a href="#">Publikasi</a></li>
              <li><a href="<?php //echo site_url('admin/comments'); 
                            ?>" <?php //echo ($this->router->fetch_class() == 'comments') ? "style='text-decoration:none;background-color:rgb(255, 255, 255);color:rgb(234, 178, 0);'" : ""; 
                                ?>>Komentar</a></li>-->
      </ul>
    </li>
    <!--
        ...
        <li class="dropdown">
          ...
          <ul <?php echo ($this->router->fetch_class() == 'user_groups' || $this->router->fetch_class() == 'user_accesses' || $this->router->fetch_class() == 'users') ? "style='display:block;'" : ""; ?>>
            ...
            <!-- <li><a href="<?php //echo site_url('admin/users'); 
                              ?>" <?php //echo ($this->router->fetch_class() == 'users') ? "style='text-decoration:none;background-color:rgb(255, 255, 255);color:rgb(234, 178, 0);'" : ""; 
