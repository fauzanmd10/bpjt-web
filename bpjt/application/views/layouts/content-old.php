...
<head>
  ...
  <link rel="stylesheet" media="screen" href="<?php echo base_url(); ?>assets/css/modal.css" />
...
<a class="popup_banner" title=" "></a>
<div id="top-page">
  <div class="clearfix">
    <div class="home left"> <a href="http://pu.go.id/"> <img src="<?php echo base_url(); ?>assets/images/home_5.png"></a> <a href="http://pu.go.id/" class="text">PU-net</a> </div>
    <!--div class="language">
				<a href="" class="bahasa"><img src="http://pu.go.id/images/Inggris-icon.png" title="english" > </a>
				<a class="bahasa" href=""><img src="http://pu.go.id/images/Indonesia-icon.png" title="indonesia"></a>
				</span></div-->
...
<div id="out-wrapper">
      ...
      <div class="container bg-menu">
        ...
        <ul class="nav">
          ...
          <li><a href="#" title="<?php echo lang('gis-bpjt'); ?>"><?php echo lang('gis-bpjt'); ?></a>
            <ul>
              <li><a href="<?php echo site_url('../gisbpjt'); ?>" target="_blank" title="<?php echo lang('gis-bpjt'); ?>"><?php echo lang('gis-bpjt'); ?></a></li>
            </ul>
          </li>
          ...
          <div class="widget col300">
            ...
            <div class="widget-content">
              <p class="ratakiri">
                ...
                Badan Pengatur Jalan Tol (BPJT)<br>
				<p>Gedung Binamarga, Lt. 2 & 3 <br>
				Jl. Pattimura 20, Kebayoran Baru Jakarta Selatan 12110<br></p>
				<a href="https://www.facebook.com/BPJTInfo/"><img src="<?php echo base_url(); ?>assets/icons/ico_facebook.png" width="32" alt="facebook" /></a>
                <a href="https://twitter.com/bpjt_info"><img src="<?php echo base_url(); ?>assets/icons/ico_twitter.png" width="32" alt="twitter" /></a>
				<?php } else { ?>
                <?php echo strip_tags($tentang_kami[0]->content); ?>
				<br>
				<p><a href="https://www.facebook.com/BPJTInfo/" target="_blank"><img src="<?php echo base_url(); ?>assets/images/icons/ico_facebook.png" width="32" alt="facebook" /></a>
                <a href="https://twitter.com/bpjt_info" target="_blank"><img src="<?php echo base_url(); ?>assets/images/icons/ico_twitter.png" width="32" alt="twitter" /></a>
				<a href="https://instagram.com/bpjt_info" target="_blank"><img src="<?php echo base_url(); ?>assets/images/icons/ico_instagram.png" width="32" alt="instagram" /></a>
				<a href="https://www.youtube.com/channel/UCEMaY1KP0A0AWWCN8xr8GIA" target="_blank"><img src="<?php echo base_url(); ?>assets/images/icons/ico_youtube.png" width="32" alt="youtube" /></a></p>
                <?php } ?>
              </p>
            </div>
          </div>
      ...
      <div class="sixteen columns">
        <p>
          <span class="tengah">
            ...
            <?php if (empty($footer)) { ?>
            Copyright © 2017 Badan Pengatur Jalan Tol (BPJT)
            <br/>
  ...
  <script type="text/javascript" src="<?php echo base_url(); ?>assets/js/vendor/modal.js" type="text/javascript"></script>
