...
<body class="loginpage">
	...
	<div class="loginfooter">
	    <p>&copy; 2023. BPJT - Badan Pengatur Jalan Tol. All Rights Reserved.</p>
	</div>
	...
	<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/application/login.js"></script>
</body>
</html>
