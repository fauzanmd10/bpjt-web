...
<ul class="list-nostyle list-inline">
    ...
    <li><a href="<?php echo site_url('admin/toll_tariffs/add'); ?>" class="btn"> <i class="icon-plus"></i> &nbsp; Tambah</a> </li>
    <?php } ?>
...
<table id="dyntable" class="table table-bordered responsive">
    ...
    <thead>
        <tr>
            ...
            <th class="head0">Gerbang Masuk</th>
            <th class="head1">Gerbang Keluar</th>
            <th class="head0">Golongan Kendaraan</th>
