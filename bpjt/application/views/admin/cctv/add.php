...
<?php echo form_open('admin/cctv/create', array('class'=>'stdform')); ?>
	<div class="tabbable">
	    <ul class="nav nav-tabs buttons-icons">
	    	<li class="active"><a data-toggle="tab" href="#contents">Tambah CCTV</a></li>
	    </ul>
								...
								<span class="field">
	                                <?php 
										echo form_dropdown('protocol', [
											...
											'mjpg' => 'mjpg',
											'embedded' => 'embedded'
										], ($cctv->protocol ?? ''), "class='uniformselect'");
									?>
								</span>
							</p>
							<p>
