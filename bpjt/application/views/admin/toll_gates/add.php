...
<?php echo form_open_multipart('admin/toll_gates/create', array('class'=>'stdform')); ?>
	<div class="tabbable">
	    <ul class="nav nav-tabs buttons-icons">
	    	<li class="active"><a data-toggle="tab" href="#contents">Tambah Gerbang Tol</a></li>
	    </ul>
	    	    ...
	    	    <div class="tabbable1">
					...
					<div class="tab-content">
						<div id="indonesia" class="tab-pane active">					    
							<p>
								<label>Nama</label>
								<span class="field"><input type="text" name="name_id" id="name-id" class="input-xxlarge" placeholder="Nama" value="<?php echo (isset($toll_gate)) ? $toll_gate['name_id'] : ''; ?>" /></span>
							</p>
							<p>
							...
							<p>
								...
								<span class="formwrapper">
									<?php if (isset($toll_gate)) { ?>
									<input type="radio" name="status_id" value='published' <?php echo ($toll_gate['status_id'] == 'published') ? 'checked' : ''; ?> /> Ya &nbsp; &nbsp;
									<input type="radio" name="status_id" id="status-id" value='draft' <?php echo ($toll_gate['status_id'] == 'draft') ? 'checked' : ''; ?> /> Tidak  &nbsp; &nbsp;
									<?php } else { ?>
