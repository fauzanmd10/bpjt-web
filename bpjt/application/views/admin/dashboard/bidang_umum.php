...
<div class="row-fluid">
    <div id="dashboard-left" class="span8">
        <ul class="shortcuts">            
            ...
            <li class="inves">
                <a href="<?php echo site_url('admin/applied_inventories'); ?>">
                    <span class="shortcuts-icon iconsi-asset"></span>
                    <span class="shortcuts-label">Manajemen Aset</span>
                </a>
            </li>
            <li class="pantau">
                <a href="http://25.51.235.246/perkantoran-bpjt" target="_blank">
