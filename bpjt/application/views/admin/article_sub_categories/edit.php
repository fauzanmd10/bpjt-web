	    	    ...
	    	    <div class="tabbable1">
					...
					<div class="tab-content">
						...
						<div id="indonesia" class="tab-pane active">					    
							<p>
								<label>Judul</label>
								<span class="field"><input type="text" name="title" class="input-xxlarge" placeholder="Judul" value="<?php echo $sub_category->name; ?>" /></span>
							</p>     
							<p>
								<label>Kategori</label>
								<span class="field">
	                                <?php echo form_dropdown('category_id', $categories, (isset($sub_category)) ? $sub_category->article_category_id : '', "class='uniformselect'"); ?>
								</span>
							</p>                       
							<p>
						...
						<div id="inggris" class="tab-pane active">
							<p>
								<label>Title</label>
								<span class="field"><input type="text" name="title" class="input-xxlarge" placeholder="Title" value="<?php echo $sub_category->name; ?>" /></span>
							</p>
							<p>
