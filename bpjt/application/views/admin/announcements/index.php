...
<ul class="list-nostyle list-inline">
    <!--<li><a href="" class="btn"> <i class="icon-list-alt"></i> &nbsp; Lihat</a> </li>-->
    <?php if ($this->user_access->add) { ?>
        <li><a href="<?php echo site_url('admin/announcements/add'); ?>" class="btn"> <i class="icon-plus"></i> &nbsp; Tambah</a> </li>
    <?php } ?>
...
<table id="dyntable" class="table table-bordered responsive">
    ...
    <thead>
        <tr>
            ...
            <th class="head1">Pengumuman</th>
            <th class="head0">Terbit</th>
