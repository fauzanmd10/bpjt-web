...
<?php echo form_open('admin/article_categories/create', array('class'=>'stdform')); ?>
	<div class="tabbable">
	    <ul class="nav nav-tabs buttons-icons">
	    	<li class="active"><a data-toggle="tab" href="#contents">Tambah Kategori</a></li>
	    </ul>
	    	    ...
	    	    <div class="tabbable1">
					...
					<div class="tab-content">
						<div id="indonesia" class="tab-pane active">					    
							<p>
								<label>Judul</label>
								<span class="field"><input type="text" name="title_id" id="title-id" class="input-xxlarge" placeholder="Judul" value="<?php echo (isset($category)) ? $category['title_id'] : ''; ?>" /></span>
							</p>                            
							<p>
								<label>Terbitkan :</label>
								<span class="formwrapper">
									<?php if (isset($category)) { ?>
									<input type="radio" name="status_id" value='published' <?php echo ($category['status_id'] == 'published') ? 'checked' : ''; ?> /> Ya &nbsp; &nbsp;
									<input type="radio" name="status_id" id="status-id" value='draft' <?php echo ($category['status_id'] == 'draft') ? 'checked' : ''; ?> /> Tidak  &nbsp; &nbsp;
									<?php } else { ?>
						...
						<div id="inggris" class="tab-pane">
							<p>
								<label>Title</label>
								<span class="field"><input type="text" name="title_en" id="title-en" class="input-xxlarge" placeholder="Title" value="<?php echo (isset($category)) ? $category['title_en'] : ''; ?>" /></span>
							</p>                            
							<p>
