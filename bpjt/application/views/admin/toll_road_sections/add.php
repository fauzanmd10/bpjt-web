...
<?php echo form_open('admin/toll_road_sections/create', array('class'=>'stdform')); ?>
	<div class="tabbable">
	    <ul class="nav nav-tabs buttons-icons">
	    	<li class="active"><a data-toggle="tab" href="#contents">Tambah Segment Ruas Tol</a></li>
	    </ul>
	    	    ...
	    	    <div class="tabbable1">
					...
					<div class="tab-content">
						<div id="indonesia" class="tab-pane active">					    
							<p>
								<label>Nama</label>
								<span class="field"><input type="text" name="name_id" id="name-id" class="input-xxlarge" placeholder="Nama" value="<?php echo (isset($toll_road_section)) ? $toll_road_section['name_id'] : ''; ?>" /></span>
							</p>
							<p>
							...
							<p>
								...
								<span class="field"><input type="text" name="road_length_id" id="road-length-id" class="input-xxlarge" placeholder="Panjang (KM)" value="<?php echo (isset($toll_road_section)) ? $toll_road_section['road_length_id'] : ''; ?>" /></span>
							</p>
							<p>
								<label>Terbitkan :</label>
								<span class="formwrapper">
									<?php if (isset($toll_road_section)) { ?>
									<input type="radio" name="status_id" value='published' <?php echo ($toll_road_section['status_id'] == 'published') ? 'checked' : ''; ?> /> Ya &nbsp; &nbsp;
									<input type="radio" name="status_id" id="status-id" value='draft' <?php echo ($toll_road_section['status_id'] == 'draft') ? 'checked' : ''; ?> /> Tidak  &nbsp; &nbsp;
									<?php } else { ?>
