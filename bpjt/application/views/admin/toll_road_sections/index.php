...
<ul class="list-nostyle list-inline">
    ...
    <li><a href="<?php echo site_url('admin/toll_road_sections/add'); ?>" class="btn"> <i class="icon-plus"></i> &nbsp; Tambah</a> </li>
    <?php } ?>
...
<table id="dyntable" class="table table-bordered responsive">
    ...
    <thead>
        <tr>
            ...
            <th class="head0">Ruas Tol</th>
            <th class="head1">Panjang (KM)</th>
