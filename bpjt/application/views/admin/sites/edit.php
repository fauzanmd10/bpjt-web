...
<?php echo form_open_multipart('admin/sites/update/' . $id, array('class'=>'stdform')); ?>
	...
	<div class="tabbable">
	    <ul class="nav nav-tabs buttons-icons">
	    	<li class="active"><a data-toggle="tab" href="#contents">Ubah Situs Terkait</a></li>
	    </ul>
					...
					<div class="tab-content">
						<div id="indonesia" class="tab-pane active">					    
							<p>
								...
								<span class="field"><input type="text" name="title" id="title" class="input-xxlarge" placeholder="Judul" value="<?php echo (isset($site)) ? $site->title : ''; ?>" /></span>
							</p>
							<p>
								<label>URL</label>
								<span class="field"><input type="text" name="content" id="content" class="input-xxlarge" placeholder="URL" value="<?php echo (isset($site)) ? $site->content : ''; ?>" /></span>
							</p>
							<div class="par">
					        	<label>Logo :</label>
							...
							<p>
								...
								<span class="formwrapper">
									<?php if (!empty($site)) { ?>
									<input type="radio" name="status" value='published' <?php echo ($site->status == 'published') ? 'checked' : ''; ?> /> Ya &nbsp; &nbsp;
									<input type="radio" name="status" id="status" value='draft' <?php echo ($site->status == 'draft') ? 'checked' : ''; ?> /> Tidak  &nbsp; &nbsp;
									<?php } else { ?>
									<input type="radio" name="status" value='published' /> Ya &nbsp; &nbsp;
									<input type="radio" name="status" id="status" value='draft' checked/> Tidak  &nbsp; &nbsp;
									<?php } ?>
								</span>
							</p>
						</div>
