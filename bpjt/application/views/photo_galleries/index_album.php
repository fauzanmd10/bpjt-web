					...
					<div class="panel panel-default">
						<div class="panel-heading" role="tab" id="headingBerita">
							<h4 class="panel-title">
								<p>
									<span class="pull-left"><?php echo lang('galeri-foto'); ?></span>
								...
								<div class="panel-group subpanel" id="accordionCapaian">
									<div class="panel panel-default">
										<div class="panel-heading" role="tab" id="headingCapaian">
											<h4 class="panel-title">
												<a style="text-transform:capitalize" href="<?php echo site_url('galeri-foto/album-foto/' . $photo_album->slug); ?>" title="<?php echo $photo_album->name; ?>">
												<?php echo $photo_album->name; ?></a>
											</h4>
										</div>
									</div>
            ...
            <div id="artikel" class="col-sm-12 col-md-8">
                ...
                <div class="body">
                    ...
                    <div class="galeri-foto col-sm-12">
                        <div class="col-sm-3">
						<a href="<?php echo site_url('galeri-foto/album-foto/' . $media->album_slug . '/show/' . create_slug($media->title) . '/' . $media->id); ?>">
						...
						<div class="col-sm-9">
                            ...
                            <h5 class="galeri-heading"><a href="<?php echo site_url('galeri-foto/album-foto/' . $media->album_slug . '/show/' . create_slug($media->title) . '/' . $media->id); ?>"><?php echo $media->title; ?></a></h5>
