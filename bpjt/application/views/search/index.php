    ...
    <div id="content" class="container-fluid">
        ...
        <div id="profil-artikel" class="row">
            ...
            <div id="artikel" class="col-sm-12 col-md-8">
                <h4 class="title"><?php echo lang('hasil-pencarian'); ?></h4>
                <hr class="divider">
				<h3 class="lead"><?php echo lang('hasil-pencarian'); ?> : <strong>"<?php echo clean_str($_GET['keyword']); ?>"</strong> &nbsp;<?php echo lang('ditemukan'); ?> <?php echo lang('dalam')?> <strong><?php echo $found_articles; ?></strong> <?php echo lang('berita'); ?></h3>
                <div class="body">
